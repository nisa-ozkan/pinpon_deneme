...
img_bullet = "bullet.png" #kahraman
img_hero = "rocket.png" #mermi
...
#bir grup düşman sprite oluşturalım
    ...
    for e in event.get():
        ...
        #space'e basılma durumunda sprite ateş ediyor
            ...
            if e.key == K_SPACE:
                fire_sound.play()
                ship.fire()
    #oyunun kendisi: sprite eylemleri, oyunun kurallarını kontrol ete, yeniden çizme
    if not finish:
